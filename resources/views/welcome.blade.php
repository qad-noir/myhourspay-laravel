...
<main>
        ...
        <div class="public-container landing-hero__grid">
            <div class="landing-hero__copy">
                ...
                <div class="landing-hero__actions">
                    @auth<a href="{{ route('dashboard') }}" class="public-button public-button--primary">Open Dashboard <span aria-hidden="true">→</span></a>@elseif(Route::has('register'))<a href="{{ route('register') }}" class="public-button public-button--primary">Start Tracking Free <span aria-hidden="true">→</span></a>@endauth
            ...
            <div class="product-stage" aria-label="Decorative preview of the myhourspay product interface">
                <div class="product-preview">
                    ...
                    <div class="preview-main">
                        ...
                        <section class="current-session"><header><small>CURRENT SESSION</small><span>Tracking</span></header><div class="session-project"><i aria-hidden="true"><svg viewBox="0 0 24 24"><path d="m13 2-9 12h7l-1 8 9-12h-7l1-8Z" /></svg></i><p><strong>Website Development</strong><span>myhourspay · Design system</span></p></div><strong class="session-time" data-preview-timer>02:46:32</strong><div class="session-controls"><button type="button" aria-label="Decorative pause button"><svg viewBox="0 0 20 20" aria-hidden="true"><path d="M6 5v10M14 5v10" /></svg></button><button type="button" aria-label="Decorative stop button"><svg viewBox="0 0 20 20" aria-hidden="true"><rect x="6" y="6" width="8" height="8" rx="1" /></svg></button></div></section>
                        <section class="preview-timeline"><div class="preview-section-title"><h3>Today’s Timeline</h3><span><b>8h 42m total</b><em>View report →</em></span></div>
    ...
    <section id="pricing" class="final-cta reveal-on-scroll"><div class="public-container final-cta__inner"><p>✦ Make every hour count</p><h2>Ready to keep a clearer<br>record of your hours?</h2><span>Sign in to record your workdays, review weekly totals and prepare accurate monthly reports.</span>@auth<a href="{{ route('dashboard') }}" class="public-button public-button--primary">Open Dashboard →</a>@else<a href="{{ route('login') }}" class="public-button public-button--primary">Log in to myhourspay →</a>@endauth<div><small>✓ Secure staff access</small><small>✓ Private hour records</small></div></div></section>
</main>
<x-public-footer />
</body></html>
