<x-app-layout>
    ...
    <section class="dashboard-stats settings-summary" aria-label="Hours settings">
        <x-dashboard.stat-card label="Default break" :value="$currentWorkspace->default_break_minutes.' min'" support="Used when adding an entry" icon="stopwatch" tone="violet" />
