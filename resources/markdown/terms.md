...
Provide accurate information, protect login credentials and promptly report suspected unauthorised access. Workspace owners must invite appropriate users, assign suitable permissions and keep access up to date. Users must act within their authority.

You are responsible for checking entered time, breaks, rates, approvals and exports before relying on them. myhourspay supports record keeping; it does not replace professional payroll, tax, employment or legal advice, determine employment status, or guarantee that a customer’s payroll complies with law. This does not remove our obligation to provide the service with reasonable care and skill.

## Plans, beta and complimentary access

The application describes available functionality and limits. Beta or complimentary access may temporarily include additional features. Its expiry does not itself authorise a new paid subscription. Existing subscriptions continue on their agreed billing schedule unless changed or cancelled.

The Free plan has lower limits. A downgrade preserves records subject to published retention arrangements, but may restrict creating or changing workspaces or using paid features. Applicable export and statutory rights remain protected.

## Trials, prices and renewal

Before subscribing, review the price, currency, taxes, billing interval, additional-seat charges and trial end date shown at checkout. Stripe processes payments. A zero-value trial invoice does not mean the recurring subscription price is zero.

A subscription trial automatically renews into the selected paid plan at its original end date unless cancelled or changed through a supported action before renewal. Separate complimentary access does not extend the Stripe trial or postpone a charge. An already-used trial does not restart merely because the plan changes.

Paid upgrades may take effect immediately with disclosed proration. Trial upgrades preserve the original trial end. Downgrades normally take effect at trial end or paid renewal; the application shows the target and effective date. Choosing Free schedules cancellation at the end of an ongoing trial or paid period where applicable. Expired subscriptions may resolve to Free immediately.

## Cancellation, refunds and consumer rights

Manage or cancel renewal through Plans & billing. If the control is unavailable, contact support promptly. Ending renewal is different from deleting an account. Unless statutory rights or an agreed remedy apply, access continues until the displayed end date and cancellation of renewal does not automatically refund an already-started period.
...
Do not use the service unlawfully, falsify another person’s records, access information without permission, distribute malicious code or deliberately disrupt the service. Obtain the rights and lawful authority needed to upload and share personal or business information.

You retain rights in your content and permit us to host, process and transmit it as necessary to provide the service. Our software, branding and other service materials remain ours or our licensors’. Use them only as permitted by this agreement and law.
